...
public class BoardController {
    ...
    public Mono<BoardInfoResponse> getBoardInfo(@PathVariable Long id) {
    ...
    @GetMapping("/board")
    public Mono<GetBoardListResponse> getBoardList(@Schema(hidden = true)
    ...
    @PostMapping("/board")
    public Mono<BoardInfoResponse> createBoard(@Validated @RequestBody CreateBoardRequest request) {
    ...
    @PatchMapping("/board")
    public Mono<BoardInfoResponse> updateBoard(@RequestBody UpdateBoardRequest request) {
    ...
    public Mono<Void> deleteBoard(@PathVariable Long id, @RequestParam String password) {
